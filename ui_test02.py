...
class MyWindow(QMainWindow, form_class):
    def __init__(self):  # 초기화자
        ...
        self.statusBar().showMessage('Test Applicatioin Ver 1.0')  # 윈도우 상태표시줄 입력
        self.test_button.clicked.connect(self.btn_clicked)  # 버튼 클릭시 연결될 함수 설정
        self.test_button.clicked.connect(self.btn_clicked2)  # 버튼 클릭시 연결될 함수 설정
        self.clear_button.clicked.connect(self.clear_button_)
